    ...
    <section ref={containerRef} className="relative h-screen min-h-[700px] overflow-hidden bg-navy-950">
      ...
      >
        ...
        <div className="overflow-hidden">
          {['WHERE EVERY', 'MOMENT', 'BECOMES UNFORGETTABLE.'].map((line, i) => (
            <motion.div
              key={line}
              initial={{ y: '110%' }}
              animate={{ y: 0 }}
        ...
        >
          ...
          <p className="text-white/30 text-xs sm:text-sm uppercase tracking-[0.2em]" style={{ fontFamily: 'var(--font-sans)' }}>
            800+ Events &middot; 10 Years &middot; 5.0 Rating
          </p>
        </motion.div>
        ...
        >
          <Link
            to="/contact"
            className="group relative inline-flex items-center gap-3 bg-gold-500 text-white px-8 py-4 text-sm uppercase tracking-[0.15em] font-semibold transition-all duration-500 hover:bg-gold-500 hover:shadow-xl hover:shadow-gold-500/20"
            style={{ fontFamily: 'var(--font-sans)' }}
          >
            {hero.ctaPrimary}
      ...
      <div className="hidden lg:flex absolute right-8 bottom-12 z-20">
        ...
        >
          MC Tana - Zimbabwe Wedding & Corporate MC &mdash; Harare, Zimbabwe
        </span>
      </div>
    </section>
  );
...
function MarqueeTicker() {
  const items = ['WEDDINGS', 'CORPORATE GALAS', 'BIRTHDAYS', 'VENUE STYLING', 'DECOR HIRE', 'COORDINATION'];
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6">
            <div>
              <p className="text-gold-500/60 text-xs uppercase tracking-[0.3em] mb-3" style={{ fontFamily: 'var(--font-sans)' }}>What We Do</p>
            ...
            >
              <div className="aspect-[3/4] overflow-hidden relative">
                ...
                <div className="absolute top-5 left-5 z-10">
                  <span className="bg-gold-500/90 text-white text-[10px] uppercase tracking-[0.2em] px-3 py-1.5 font-semibold" style={{ fontFamily: 'var(--font-sans)' }}>
                    {project.category}
                  </span>
                </div>
              </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <div className="flex gap-10 sm:gap-16">
              <div>
                <div className="text-gold-500 font-heading text-3xl sm:text-4xl italic leading-none">2014</div>
            ...
            <div className="relative">
              <div className="overflow-hidden">
                <img
                  ...
                  alt="MC Tana - Zimbabwe Wedding & Corporate MC"
              ...
              <div className="absolute -bottom-8 -left-6 sm:-left-10 w-[45%] overflow-hidden border-4 border-navy-950 shadow-2xl">
                <img
                  ...
                  alt="MC Tana - Zimbabwe Wedding & Corporate MC team"
                  className="w-full aspect-square object-cover object-center"
                  loading="lazy"
                />
              </div>
              <div className="absolute -top-4 -right-4 sm:-right-6 bg-gold-500 text-white p-5 sm:p-7 shadow-2xl">
                <div className="text-center">
                  <div className="font-heading text-xs uppercase tracking-[0.2em] leading-none" style={{ fontFamily: 'var(--font-sans)' }}>Est.</div>
                  <div className="font-heading text-3xl sm:text-4xl italic leading-none mt-1">2014</div>
                </div>
              </div>
...
function WhyChooseUs() {
  ...
  const points = [
    { title: 'Bespoke Design', desc: 'No templates. Every event is designed from scratch to reflect your unique vision.' },
    { title: 'End-to-End Service', desc: 'From concept to cleanup. We handle every detail so you can enjoy the moment.' },
    { title: 'Premium Quality', desc: 'Only the finest materials, freshest florals, and most elegant furnishings.' },
    { title: 'Proven Track Record', desc: 'Hundreds of successful events and a reputation built entirely on referrals.' },
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            ...
            <h2 className="font-heading text-white leading-[0.95] italic mb-12" style={{ fontSize: 'clamp(2rem, 4.5vw, 3rem)' }}>
              Why Choose <span className="text-gold-500">MC</span>
            </h2>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="flex flex-col items-center gap-3">
                {t.avatar && (
                  <img src={t.avatar} alt={t.name} className="w-12 h-12 rounded-full object-cover object-center border-2 border-gold-500/30" loading="lazy" />
                )}
...
function CTASection() {
  ...
  return (
    <section ref={ref} className="relative py-28 sm:py-36 lg:py-48 overflow-hidden">
      <motion.div className="absolute inset-0" style={{ y: bgY }}>
        <img src={homeCta.backgroundImage} alt="MC Tana - Zimbabwe Wedding & Corporate MC" className="w-full h-[130%] object-cover object-center" loading="lazy" />
      ...
      <div className="relative z-20 max-w-5xl mx-auto px-5 sm:px-8 lg:px-12 text-center">
        <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-80px' }} transition={{ duration: 1 }}>
          ...
          <h2 className="font-heading text-white leading-[0.92] italic mb-8" style={{ fontSize: 'clamp(2.5rem, 8vw, 6rem)' }}>
            YOUR EVENT<br />
            <span className="text-gold-500">OUR STAGE</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to="/contact" className="group relative inline-flex items-center gap-3 bg-gold-500 text-white px-8 py-4 text-sm uppercase tracking-[0.15em] font-semibold transition-all duration-500 hover:bg-gold-500 hover:shadow-xl hover:shadow-gold-500/25" style={{ fontFamily: 'var(--font-sans)' }}>
              {homeCta.ctaPrimary}
              <ArrowRight size={16} className="transition-transform group-hover:translate-x-1" />
            </Link>
            <a href={`https://wa.me/${business.whatsappNumber}?text=${encodeURIComponent(homeCta.whatsappText)}`} target="_blank" rel="noopener noreferrer" className="group inline-flex items-center gap-3 border border-gold-500/40 text-gold-400 px-8 py-4 text-sm uppercase tracking-[0.15em] font-semibold transition-all duration-500 hover:bg-gold-500/10 hover:border-gold-500/60" style={{ fontFamily: 'var(--font-sans)' }}>
